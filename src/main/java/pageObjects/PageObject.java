...
public class PageObject implements IPageObject {
    ...
    @Override
    public List<WebElement> getElements(String name) throws NoSuchFieldException, IllegalAccessException {
        Field field = somePageObject.getClass().getDeclaredField(name);
        field.setAccessible(true);
        return (List<WebElement>) field.get(somePageObject);
    }

    Object somePageObject; // it should be set for web page or EPAM Test App WebElements
